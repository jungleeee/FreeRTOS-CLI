/**
  ********************************************************************************
  * @File Name    : cli_register.h
  * @Author       : Jungle
  * @Mail         : Mail
  * @Created Time : 2018年3月20日 10:22:17
  * @Version      : V1.0
  * @Last Changed : 2018年3月23日 17:45:31
  * @Brief        : brief
  ********************************************************************************
  */

/* Define to prevent recursive inclusion ---------------------------------------*/
#ifndef __CLI_REGISTER_H_
#define __CLI_REGISTER_H_
